...
def test_verify_email_syntax():
    assert verify_email_syntax("user@example.com") is True
...
def test_generate_email_permutations():
    perms = generate_email_permutations("Jane Doe", "google.com")
    assert "jane.doe@google.com" in perms
    assert "jane@google.com" in perms
    assert "j.doe@google.com" in perms
